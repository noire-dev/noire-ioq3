function GameTool_Create_Init(toolID) {
    //Tool ID
    cvar.set("toolgun_tool", toolID);

    //Tool text
    cvar.set("toolgun_tooltext", "Create");
    cvar.set("toolgun_tooltip1", "Creates an object");
...
function GameTool_Create_Call(toolID, targetID, playerID, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9) {
    console.log("tool - " + tool.list[toolID].name + " is client-side");
}

tool.register("noiredev.create", "Create", GameTool_Create_Init, GameTool_Create_Call);