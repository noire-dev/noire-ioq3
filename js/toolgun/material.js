//Tool ID
cvar.set("toolgun_tool", "1");

//Tool text
cvar.set("toolgun_tooltext", "Material");
cvar.set("toolgun_tooltip1", "Applies material to object");
cvar.set("toolgun_tooltip2", "Select the material");
...
cvar.set("toolgun_toolset1", "Material:");
