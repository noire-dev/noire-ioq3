//Tool ID
cvar.set("toolgun_tool", "10");

//Tool text
cvar.set("toolgun_tooltext", "Replace");
cvar.set("toolgun_tooltip1", "Replaces item");
cvar.set("toolgun_tooltip2", "Select the item");
cvar.set("toolgun_tooltip3", "in the entity tab");
...
cvar.set("toolgun_toolset1", "Class:");
