//Tool ID
cvar.set("toolgun_tool", "6");

//Tool text
cvar.set("toolgun_tooltext", "Health");
cvar.set("toolgun_tooltip1", "Sets the HP of an object");
