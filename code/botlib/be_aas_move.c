...
void AAS_JumpReachRunStart(aas_reachability_t* reach, vec3_t runstart) {
	...
	//
	AAS_PredictClientMovement(&move, -1, start, PRESENCE_NORMAL, true, vec3_origin, cmdmove, 1, 2, 0.1f, SE_ENTERWATER | SE_ENTERSLIME | SE_ENTERLAVA | SE_HITGROUNDDAMAGE | SE_GAP, 0, false);
...
void AAS_TestMovementPrediction(int entnum, vec3_t origin, vec3_t dir) {
	...
	AAS_PredictClientMovement(&move, entnum, origin, PRESENCE_NORMAL, true, velocity, cmdmove, 13, 13, 0.1f, SE_HITGROUND, 0, true);  // SE_LEAVEGROUND);
