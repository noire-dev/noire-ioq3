...
#define AAS_BoxOnPlaneSide(absmins, absmaxs, p) (((p)->type < 3) ? (((p)->dist <= (absmins)[(p)->type]) ? (1) : (((p)->dist >= (absmaxs)[(p)->type]) ? (2) : (3))) : (AAS_BoxOnPlaneSide2((absmins), (absmaxs), (p))))  // end of the function AAS_BoxOnPlaneSide
//===========================================================================
