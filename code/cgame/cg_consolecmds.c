...
static void CG_ConfirmOrder_f(void) {
	trap_SendConsoleCommand(EXEC_INSERT, va("cmd vtell %d %s\n", cgs.acceptLeader, VOICECHAT_YES));
	trap_SendConsoleCommand(EXEC_INSERT, "+button5; wait; -button5");
...
static void CG_DenyOrder_f(void) {
	...
	trap_SendConsoleCommand(EXEC_INSERT, "+button6; wait; -button6");
	if(cg.time < cgs.acceptOrderTime) {
		cgs.acceptOrderTime = 0;
	}
}
...
static void CG_TaskOffense_f(void) {
	if(cgs.gametype == GT_CTF || cgs.gametype == GT_1FCTF) {
		trap_SendConsoleCommand(EXEC_INSERT, va("cmd vsay_team %s\n", VOICECHAT_ONGETFLAG));
	} else {
		trap_SendConsoleCommand(EXEC_INSERT, va("cmd vsay_team %s\n", VOICECHAT_ONOFFENSE));
	}
	trap_SendClientCommand(va("teamtask %d\n", TEAMTASK_OFFENSE));
...
static void CG_TaskOwnFlag_f(void) { trap_SendConsoleCommand(EXEC_INSERT, va("cmd vsay_team %s\n", VOICECHAT_IHAVEFLAG)); }

static void CG_TauntKillInsult_f(void) { trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay kill_insult\n"); }

static void CG_TauntPraise_f(void) { trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay praise\n"); }

static void CG_TauntTaunt_f(void) { trap_SendConsoleCommand(EXEC_INSERT, "cmd vtaunt\n"); }

static void CG_TauntDeathInsult_f(void) { trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay death_insult\n"); }

static void CG_TauntGauntlet_f(void) { trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay kill_gauntlet\n"); }
