...
static void CG_TauntKillInsult_f (void ) {
	trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay kill_insult\n");
}

static void CG_TauntPraise_f (void ) {
	trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay praise\n");
}

static void CG_TauntTaunt_f (void ) {
	trap_SendConsoleCommand(EXEC_INSERT, "cmd vtaunt\n");
}

static void CG_TauntDeathInsult_f (void ) {
	trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay death_insult\n");
}

static void CG_TauntGauntlet_f (void ) {
	trap_SendConsoleCommand(EXEC_INSERT, "cmd vsay kill_gauntlet\n");
}
