...
=======================
*/
bool LAN_UpdateVisiblePings(int source) { return CL_UpdateVisiblePings_f(source); }
...
====================
*/
int LAN_GetServerStatus(char* serverAddress, char* serverStatus, int maxLen) { return CL_ServerStatus(serverAddress, serverStatus, maxLen); }
...
static int GetConfigString(int index, char* buf, int size) {
	...
	if(index < 0 || index >= MAX_CONFIGSTRINGS) return false;
