...
void SV_PhysicsCreateModel(int entityID, int modelindex, float x, float y,
                           float z, float mass);
...
void SV_PhysicsGetAngularVelocity(int entityID, float *vx, float *vy,
                                  float *vz);
...
void BT_PhysicsTrace(const float *start, const float *end, const float *mins,
                     const float *maxs, int skipEntity, physTrace_t *result);
