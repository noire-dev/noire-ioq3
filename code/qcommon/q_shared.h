...
#define Q_PRINTF_FUNC(fmt, va) __attribute__((format(gnu_printf, fmt, va))) __attribute__((format(ms_printf, fmt, va)))
#else
...
#define MAX_QEXTENDEDPATH 256  // extended max length of a quake game pathname
#ifdef PATH_MAX
